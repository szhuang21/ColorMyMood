        ...
        dataLabels: [
          {
            ...
            //   image,
            formatter: function () {
              // Access the point's custom data to decide if the image should be shown
                  // Assume 'dataUrl' is available in the scope or fetched/stored appropriately
                  console.log('<img src="' + image + '" style="width: 20px; height: 20px;"/>')
                  return '<img src="' + image + '" style="width: 20px; height: 20px;"/>';
          },
            style: {
              textOutline: "none",
              fontWeight: "normal",
...
drawCalendar('https://ej2.syncfusion.com/demos/src/schedule/images/newyear.svg')
...
toolbar.addSaveButton(async () => {
  ...
  //const dataUrl = editor.toSVG();
  const strval = '<img src="'+dataUrl+'" style="width: 20px; height: 20px;"/>'

  //console.log(dataUrl)
// const svgElem = editor.toSVG();
// console.log('The saved SVG:', svgElem.outerHTML);
drawCalendar(dataUrl)
});